...
<head>
    ...
    <!--Mystyle-->
    <link rel="stylesheet" type="text/css" href="{{ asset('frontend/css/meditationTwo.css') }}">
    ...
    <div id="home" class="hero-image">
        <div class="hero-video">
            <div class="hero-wo">
                <!-- <video autoplay="autoplay" loop="loop" muted defaultMuted playsinline id="myVideo" controls>
                    ...
                    <video> -->
                <img src="{{ asset('frontend/assets/image/lake1.jpeg') }}" alt="" />
            </div>
                        ...
                        <div class="flex-center" style="display: flex;margin-top: 20px;">
                            ...
                            <div class="input-group">
                                <input type="number" class="form-control"
                                    aria-label="Amount (to the nearest dollar)" id="timeValue" min="0"
                                    max="15" oninput="if(value> 10)value=10;if(value< 1)value=1">
        ...
        <div>
            <audio id="myAudio" loop>
                <source src="{{ asset('frontend/assets/video/lake.mp3') }}" />
            </audio>
        </div>
        <!-- 音频1 -->
        <div>
...
<script type="text/javascript" src="{{ asset('frontend/js/meditationTwo.js') }}"></script>
