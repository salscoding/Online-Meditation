    ...
    */
    ...
    $(".nav-link-style").on("click", function () {
        ...
        if (currentLayout !== "dark-layout") {
            ...
            // save the layout data in the user database for future use using ajax call with csrf token
            $.ajaxSetup({
                headers: {
            ...
            $.ajax({
                type: "POST",
                url: "/users/save-layout",
                data: {
                    theme: switchToLayout,
                },
                success: function (data) {
                    ...
                    Swal.fire(
                        "Theme Set!",
                        "Your theme preference has been set.",
                        "success"
                    );
                },
            });
            ...
            if (currentLayout === prevLayout) {
                switchToLayout = "semi-dark-layout";
                $.ajaxSetup({
                    headers: {
                        "X-CSRF-TOKEN": $('meta[name="csrf-token"]').attr(
                            "content"
